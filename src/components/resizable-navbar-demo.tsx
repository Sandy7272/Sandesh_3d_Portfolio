    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        // FIX: avoid animating width between 100% and fit-content which causes layout jank.
        // Instead we use maxWidth to collapse, keeping the container a block element.
        maxWidth: visible ? "360px" : "1280px",
        y: visible ? 12 : 0,
        paddingLeft: "16px",
        paddingRight: "16px",
      }}
